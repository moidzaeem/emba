...
<div class="container">
    ...
    <div class="card mb-4 shadow-sm">
        <div class="card-body">
            <form action="{{ route('participants.import') }}" method="POST" enctype="multipart/form-data" class="row g-3 align-items-center">
                @csrf
                <div class="col-md-6">
                ...
                <tbody>
                    @forelse($participants as $p)
                        <tr>
                            ...
                            <td>
                                <span class="badge bg-info text-dark">{{ $p->focus }}</span>
                            </td>
                            <td>
                            ...
                            <td class="text-center">
                                ...
                                <form action="{{ route('participants.destroy', $p) }}" method="POST" class="d-inline-block" onsubmit="return confirm('Are you sure you want to delete this participant?');">
                                    @csrf
                                    @method('DELETE')
